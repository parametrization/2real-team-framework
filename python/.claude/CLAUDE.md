...
| Role | Level | Name |
|------|-------|------|
| Manager | Senior VP | Oscar Fischer |
| Tech Lead | Staff | Omar Ito |
| Software Engineer | Principal | Umar Nakamura |
| Software Engineer | Senior | Mei-Lin Sato |
| QA Engineer | Senior | Beatriz Nair |

### Key Rules

- **Commit identity:** Each team member commits using per-commit `-c` flags — never set global/repo git config.
...
- **GitHub Projects** — project/feature tracking
- **GitHub Issues** — story/task/bug tracking

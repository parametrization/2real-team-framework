...
- [Framework extraction state](project_framework_extraction_state.md) — baseline: released v0.8.0 (Phase 6 W3 fail-closed foundation + flagship #102-P0 asset port: dispatcher blocks-unless-FAIL_OPEN #175, per-behavior-file gate #174/#176, promotion/genericization pipeline #102-P0, branch-freshness+roster-union donors #179, Must-fix-vs-tech-debt norm #180, rename cost-out #177; 5 PRs/1 CR/629 tests; #164 ledger fired for real), OIDC on both registries; deferred: #102 **P2 tranche** (next candidate), installer-completeness #162/#142/#148/#141/#155, #110, review-gate tranche. Read first.

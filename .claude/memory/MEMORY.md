...
- [Framework extraction state](project_framework_extraction_state.md) — pickup point: PR #41, what's built (10 hooks/4 libs/bootstrap/roster/skill/CLI), what's deferred (review-gate tranche, branch-freshness, node CLI). Read first.

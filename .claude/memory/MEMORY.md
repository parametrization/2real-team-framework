...
- [Framework extraction state](project_framework_extraction_state.md) — baseline: released v0.4.0 (Phase 3 installer overhaul: YAML install config, meta/child modes, 13 skills, node bridge), OIDC publishing on both registries; deferred: review-gate tranche, branch-freshness, tech-debt #74/#75/#77/#82/#90/#94. Read first.
